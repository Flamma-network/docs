...
| [Integrate a Wallet in Your Front-End Application](/QuickDappDeploy/integratedwalletconnect.mdx) | How to use a template to set up a front-end application to integrate WalletConnect using React in 5 minutes.  |
| [ERC20 Token Claim Front-End Template](/QuickDappDeploy/minterc20.mdx) | How to use a template to set up a front-end application to mint ERC20 tokens using React and WalletConnect in 10 minutes. |
