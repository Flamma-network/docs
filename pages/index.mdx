...
| [Verify ERC-20 Smart Contract](/QuickDappDeploy/verify/verify20.mdx) | Detailed Guide to Verify the "LaughCoin" ERC-20 Smart Contract on flascan.  |
| [Verify ERC-721 Smart Contract](/QuickDappDeploy/verify/verify721.mdx) | Detailed Guide to Verify the "SunFlower" NFT Smart Contract on flascan.  |
