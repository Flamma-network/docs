...
| :----- | :---- |
| [Get $FLA Test Funds]()     |  Get test tokens to use on the Flamma network for development and testing purposes.   |
...
| [Create an ERC-20 Token]() | Design and deploy your own [ERC-20](https://eips.ethereum.org/EIPS/eip-20) token, the standard for FT.  |
