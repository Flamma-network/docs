...
3. Explorer: The blockchain instance for the network where your contract is deployed (e.g., https://testnet.flascan.net/).

> If you have not already deployed the contract, please refer to the instructions provided [Create an ERC-20 token](/pages/QuickDappDeploy/erc20.mdx).
