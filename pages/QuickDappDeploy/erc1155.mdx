...
Create a file named `Icecream.sol` in the contracts directory.

![erc1155.sol](/images/erc1155_1.png)

## Step 2: Write the ERC-1155 Smart Contract

Copy the following code and paste it into your `Icecream.sol` file:
...
5. Click "Compile Icecream.sol" button. Ensure there are no compilation errors.
