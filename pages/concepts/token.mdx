...
## Tokenomics
FLA is the essential resource within the FLAMMA NETWORK ecosystem, with a capped supply of 1.2 billion tokens. These tokens power the network by enabling staking and daily operations, such as initiating transactions, thereby securing the ecosystem.
...
- **40% SureAirdrop:** 400 million FLA tokens are allocated to the SureAirdrop program to incentivize active participation and contributions to the Flamma network.

- **25% Eco:** 250 million FLA tokens for ecosystem development. Projects that receive grants typically have a lock-up period of 1 to 3 years.

- **20% Community:** 200 million FLA tokens are reserved for community rewards, ensuring continuous engagement and growth within the Flamma community.
